...
class Extraction():
    ...
    def cast_data(self):
        ...
        self.dataframe["passenger_count"] = self.dataframe["passenger_count"].astype("Int8") #noqa
        
        self.dataframe["store_and_fwd_flag"] = self.dataframe["store_and_fwd_flag"].replace(["N", "Y"], [False, True]) #noqa
        self.dataframe["store_and_fwd_flag"] = self.dataframe["store_and_fwd_flag"].astype("boolean") #noqa
        
        self.dataframe["tpep_pickup_datetime"] = pd.to_datetime(self.dataframe["tpep_pickup_datetime"]) #noqa
        self.dataframe["tpep_dropoff_datetime"] = pd.to_datetime(self.dataframe["tpep_dropoff_datetime"]) #noqa
